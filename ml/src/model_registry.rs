use crate::types::{
    ...
    GetModelVersionDownloadUriResponse, GetModelVersionResponse, GetRegisteredModelPermissionLevelsResponse,
    ListModelsResponse, ListRegistryWebhooksResponse, ListTransitionRequestsResponse,
    RegisteredModelPermissions, RegisteredModelPermissionsRequest, RejectTransitionRequestRequest,
    RejectTransitionRequestResponse, RenameModelRequest, RenameModelResponse,
    SearchModelVersionsResponse, SearchModelsResponse, SetModelTagRequest,
